  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-sm-12">
        ...
        <h2>Personality Development <small>Upgrade your skills with newest courses</small></h2>
        </div>
        ...
        <div class="owl-carousel owl-theme owl-courses">
          ...
          $category = "Personality Development"; // Specify the category here
